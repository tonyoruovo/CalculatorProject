...
/*
 * Date: 15 Aug 2021----------------------------------------------------------- 
 * Time created: 14:13:45---------------------------------------------------  
 * Package: mathaid.calculator.base.converter------------------------------------------------ 
 * Project: LatestPoject2------------------------------------------------ 
 * File: UnknownURLException.java------------------------------------------------------ 
 * Class name: UnknownURLException------------------------------------------------ 
 */
/**
 * <p>
 * Exception wrapper that throws {@code java.net.MalformedURLException} to
 * indicate that the uniform resource locator provided is not a valid one.
 * </p>
 * <p>
 ...
 */
public class UnknownURLException extends BaseException {

	/*
	 * Date: 15 Aug 2021-----------------------------------------------------------
	 * Time created: 14:14:35---------------------------------------------------
	 */
	/**
	 * Throws the given {@link java.net.MalformedURLException} object, after writing
	 ...
	 * @param cause          a {@code java.net.MalformedURLException}, the purpose
	 ...
	 *                              {@code java.net.MalformedURLException} after
	 ...
	 *                              locale-sensitive
	 */
	public UnknownURLException(LocalizableMessage localizableMsg, MalformedURLException cause, Object... args)
			throws Exception {
