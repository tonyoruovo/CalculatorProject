 ...
 */
public interface CommonSyntax<E extends NameExpression, P extends Parser<String, E, P>> extends Syntax<String, E, P> {
	...
	private static Map<String, Type<String>> getMyCommonTypes() {
		...
		m.put(EOF, new Builder.T("", Precedence.LOWEST));
		m.put(PLUS, new Builder.T("+", Precedence.INFIX_3));
		m.put(MINUS, new Builder.T("-", Precedence.INFIX_3));
		m.put(ASTERISK, new Builder.T("*", Precedence.INFIX_2));
		m.put(FORWARD_SLASH, new Builder.T("/", Precedence.INFIX_2));
		m.put(CARET, new Builder.T("^", Precedence.INFIX_1));
		m.put(COMMA, new Builder.T(",", Precedence.HIGHEST));
		m.put(LEFT_PARENTHESIS, new Builder.T("(", Precedence.HIGHEST));
		m.put(RIGHT_PARENTHESIS, new Builder.T(")", Precedence.LOWEST));
		m.put(LEFT_BRACKET, new Builder.T("[", Precedence.HIGHEST));
		m.put(RIGHT_BRACKET, new Builder.T("]", Precedence.LOWEST));
		m.put(NAME, new Builder.T("", Precedence.HIGHEST));
		m.put(PERIOD, new Builder.T(".", Precedence.PREFIX_1));
		m.put(BANG, new Builder.T("!", Precedence.POSTFIX_1));
		m.put(QUOTE, new Builder.T("'", Precedence.POSTFIX_2));
	...
	private static Map<String, Type<String>> getMyBasicTypes() {
		Map<String, Type<String>> m = new HashMap<>();
		m.put(EOF, new Builder.T("", Precedence.LOWEST));
		m.put(PLUS, new Builder.T("+", Precedence.HIGHEST));
		m.put(MINUS, new Builder.T("-", Precedence.HIGHEST));
		m.put(ASTERISK, new Builder.T("*", Precedence.HIGHEST));
		m.put(FORWARD_SLASH, new Builder.T("/", Precedence.HIGHEST));
		m.put(CARET, new Builder.T("^", Precedence.BASIC_CARET_HIGHEST));
		m.put(COMMA, new Builder.T(",", Precedence.HIGHEST));
		m.put(LEFT_PARENTHESIS, new Builder.T("(", Precedence.HIGHEST));
		m.put(RIGHT_PARENTHESIS, new Builder.T(")", Precedence.HIGHEST));
		m.put(LEFT_BRACKET, new Builder.T("[", Precedence.HIGHEST));
		m.put(RIGHT_BRACKET, new Builder.T("]", Precedence.LOWEST));
		m.put(NAME, new Builder.T("", Precedence.HIGHEST));
		m.put(PERIOD, new Builder.T(".", Precedence.HIGHEST));
		m.put(BANG, new Builder.T("!", Precedence.HIGHEST));
		m.put(QUOTE, new Builder.T("'", Precedence.HIGHEST));
		return Collections.unmodifiableMap(m);
	}
	 ...
	 */
	static class Builder<E extends NameExpression> {
		/**
		 ...
		 */
		private static class S<E extends NameExpression> implements CommonSyntax<E, PrattParser<E>> {
			/**
			 ...
			 */
			Map<Type<String>, Parselet<String, E, PrattParser<E>>> infixParselet = new HashMap<>();
			/**
			 ...
			 */
			Map<Type<String>, Parselet<String, E, PrattParser<E>>> prefixParselet = new HashMap<>();
			/**
			...
			public Type<String> getType(Character c) {
				...
				for (Iterator<Type<String>> i = types.iterator(); i.hasNext();) {
					t = i.next();
					if ((!t.name().isEmpty()) && t.name().toString().charAt(0) == c)
						return t;
				}
				return null;
			}
			 ...
			 */
			@Override
			public Parselet<String, E, PrattParser<E>> getInfixParselet(Type<String> type) {
			 ...
			 */
			@Override
			public Parselet<String, E, PrattParser<E>> getPrefixParselet(Type<String> type) {
		 ...
		 */
		/**
		 * Class to provide implementation for the {@code Type} interface. This is a
		 * {@code Type} object that wraps a string.
		 * 
		 * @author Oruovo Anthony Etineakpopha
		 * @email tonyoruovo@gmail.com
		 *
		 */
		private static class T implements Type<String> {
			/**
			 * The string that is wrapped by this class.
			 */
			String n;
			/**
			...
			/*
			 * Date: 1 Aug 2021-----------------------------------------------------------
			 * Time created: 14:32:28---------------------------------------------------
			 */
			/**
			 * Sole constructor to initialise a {@code T} object with a given name and
			 * {@code Precedence}.
			 * 
			 * @param name a string corresponding to the type.
			 * @param p    a {@code Precedence} that will determine the index that a token
			 *             of this type will have during order of operation.
			 */
			T(String name, Precedence p) {
				n = name;
				if (p == null)
					new NullException(Precedence.class);
				pre = p;
			}

			/*
			 * Most Recent Date: 1 Aug 2021-----------------------------------------------
			 * Most recent time created: 14:35:48--------------------------------------
			 */
			/**
			 * Returns the string name given to this type.
			 * 
			 * @return a string object given to this type.
			 */
			@Override
			public String name() {
				return n;
			...
			/*
			 * Most Recent Date: 1 Aug 2021-----------------------------------------------
			 * Most recent time created: 14:36:36--------------------------------------
			 */
			/**
			 * {@inheritDoc}
			 * 
			...
			/*
			 * Most Recent Date: 1 Aug 2021-----------------------------------------------
			 * Most recent time created: 14:37:53--------------------------------------
			 */
			/**
			 * {@inheritDoc}
			 * 
			...
			@Override
			public int hashCode() {
				return n.hashCode() & pre.hashCode();
			}

			/*
			 * Most Recent Date: 1 Aug 2021-----------------------------------------------
			 * Most recent time created: 14:38:04--------------------------------------
			 */
			/**
			 * {@inheritDoc}
			 * 
			...
			public boolean equals(Object o) {
				if (!(o instanceof T))
					return false;
				T t = (T) o;
				return n.equals(t.n) && pre == t.pre;
			}

			/*
			 * Most Recent Date: 1 Aug 2021-----------------------------------------------
			 * Most recent time created: 14:38:22--------------------------------------
			 */
			/**
			 * Returns the string representation of this {@code Type}.
			 * 
			 * @return {@inheritDoc}
			 */
			@Override
		 ...
		 */
		public CommonSyntax<E, PrattParser<E>> build() {
			return syntax;
		}
		 ...
		 *                          build.
		 */
		public Builder<E> registerInfixParselet(Type<String> type, Parselet<String, E, PrattParser<E>> infixParselet) {
...
//				throw new IllegalArgumentException("Unknown type detected");
		 ...
		 *                          build.
		 */
		public Builder<E> registerPrefixParselet(Type<String> type,
				Parselet<String, E, PrattParser<E>> prefixParselet) {
			if (!syntax.types.contains(type))
				new IllformedSyntaxException(ExceptionMessage.UNKNOWN_TYPE_DETECTED);
		 ...
		 */
		public Builder<E> registerWhiteSpace(Character whitespace) {
		 ...
		 *                          alphabetic (A-Z, a-z).
		 */
		public Builder<E> registerPunctuatorAndDelimeter(Character c) {
		 ...
		 *                          {@code false}.
		 */
		public Builder<E> registerLetter(Character letter) {
		 ...
		 */
		public Builder<E> registerDigit(Character digit) {
		 ...
		 *         being built.
		 */
		public Builder<E> registerKeyword(String keyword) {
		 ...
		 *         being built.
		 */
		public Builder<E> registerType(Type<String> type) {
		 ...
		 *         syntax being built.
		 */
		public Builder<E> registerTypes(Collection<Type<String>> types) {
		 ...
		 */
		public Builder<E> registerFunctionDelimiters(Character[] openAndClose) {
		 ...
		 *                          {@link #registerPunctuatorAndDelimeter(Character)}.
		 */
		public Builder<E> registerPrecedenceDirectors(Character[] directors) {
		 ...
		 */
		public Builder<E> registerArgDelimiter(Character argDelimiter) {
		 ...
		 *                          {@link #registerTypes(Collection)}.
		 */
		public Builder<E> registerNameType(Type<String> nameType) {
